              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="mt-6 text-lg text-gray-600 max-w-lg mx-auto lg:mx-0">
                    Create your account and unlock a world of amazing events.
                    Connect with communities, discover experiences, and create
            ...
            <div className="w-full lg:w-1/2 max-w-md">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 hover:shadow-2xl transition-all duration-300">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-neutral font-serif">
                    Create Account
                  </h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="form-control">
                    <label className="label">
                      <span className="label-text text-lg font-semibold text-neutral">
                        Full Name
                      </span>
                    </label>
