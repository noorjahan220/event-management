                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-2xl shadow-lg p-8">
                            <h2 className="text-2xl font-bold text-gray-800 mb-6 font-serif">About This Event</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6">
                            <h3 className="text-xl font-bold text-gray-800 mb-4 font-serif">Event Details</h3>
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-[#F56565]/10 rounded-lg flex items-center justify-center">
                                        <svg className="w-5 h-5 text-[#F56565]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-semibold text-gray-800">{event.deadline}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-[#F56565] to-[#E53E3E] rounded-2xl shadow-lg p-6 text-white">
                            <h3 className="text-xl font-bold mb-4 font-serif">Registration</h3>
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className={`text-2xl font-bold ${event.seats < 10 ? 'text-red-200' : 'text-green-200'}`}>
                                        {event.seats}
                                    </span>
                                </div>
                                <div className="pt-4">
