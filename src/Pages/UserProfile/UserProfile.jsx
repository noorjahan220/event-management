                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            ...
                            <div className="bg-gradient-to-b from-[#F56565] to-[#E53E3E] p-8 text-white lg:col-span-1">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <h2 className="text-2xl font-bold font-serif mb-2">{user?.displayName || 'User'}</h2>
                            ...
                            <div className="p-8 lg:col-span-2">
                                <div className="mb-8">
                                    <h3 className="font-serif text-2xl font-bold text-gray-800 mb-2">Profile Information</h3>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                                    ...
                                    <div className="form-control">
                                        <label className="label">
                                            <span className="label-text font-semibold text-gray-800 text-lg">Full Name</span>
                                        </label>
                                    ...
                                    <div className="form-control">
                                        <label className="label">
                                            <span className="label-text font-semibold text-gray-800 text-lg">Email Address</span>
                                        </label>
                                        <div className="relative">
                                            <input
                                                type="email"
                                        ...
                                        <p className="text-gray-500 text-sm mt-2">Email address cannot be changed</p>
                                    </div>
