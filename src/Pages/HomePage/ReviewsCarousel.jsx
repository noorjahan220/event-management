            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Discover why thousands of people trust EventFlow for their event experiences
                    </p>
                </div>
                    ...
                    <div className="overflow-hidden">
                        ...
                        >
                            {reviews.map((review, index) => (
                                ...
                                >
                                    <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 border border-gray-100 hover:shadow-2xl transition-all duration-300">
                                        {/* Quote Icon */}
                                        <div className="mb-6">
